...
The v0.1.0 reader tranche is the **complete Sets chapter**: seven source units, six sections, three original diagrams, definitions, proofs and exercises. It is not the whole book. That release snapshot contains 21 source-aligned translations. Current `main` contains 60 reviewed source-aligned translations, leaving 662 of the frozen 722-unit inventory; the Relations, Functions, Size of Sets, Arithmetization and Infinite chapters have complete source translations, including both alternate non-enumerability presentations, both constructions of the reals, Dedekind's philosophical reflection and the closure proof of Schröder-Bernstein. Propositional Logic now continues through its Syntax and Semantics preliminaries and formation-sequences sections. Their integrated readers are not yet built, and none of these later sources is included in the Sets PDF's layout acceptance. See `provenance/CURRENT_MAIN_QA.json` for the branch/release distinction.
