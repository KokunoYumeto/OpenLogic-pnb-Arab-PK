...
The v0.1.0 reader tranche is the **complete Sets chapter**: seven source units, six sections, three original diagrams, definitions, proofs and exercises. It is not the whole book. That release snapshot contains 21 source-aligned translations. Current `main` contains 70 reviewed source-aligned translations, leaving 652 of the frozen 722-unit inventory; the Relations, Functions, Size of Sets, Arithmetization and Infinite chapters have complete source translations, including both alternate non-enumerability presentations, both constructions of the reals, Dedekind's philosophical reflection and the closure proof of Schröder-Bernstein. Propositional Logic includes the complete shared Proof Systems survey sequence—sequent calculus, natural deduction, tableaux and axiomatic deduction—and now continues into the detailed Sequent Calculus chapter through its finite-side semantics, empty-side cases, tagged initial sequents and logical/structural rule orientation. Its integrated reader is not yet built, and none of these later sources is included in the Sets PDF's layout acceptance. See `provenance/CURRENT_MAIN_QA.json` for the branch/release distinction.
